...
- [x] Simulação Frete: Camilo deve cotar nos 3 CNPJs obrigatoriamente (se cota em 1, cota nos 3)
- [x] Simulação Frete: Flor de Minas deve retornar cotação para MG e SP sempre
