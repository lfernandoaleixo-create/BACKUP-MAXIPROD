...
const TEST_CLIENTS = "('CLIENTE TESTE REGRA','CLIENTE MANUAL TICK TEST','CLIENTE LEGACY VIBRATION TEST','CLIENTE RECENT VIBRATION TEST','CLIENTE TESTE COBRANCA','__TEST_PROPOSTA_EXCLUSION__','__TEST_CLIENT_SUMMARY__')";
const THRESHOLD = 3;
