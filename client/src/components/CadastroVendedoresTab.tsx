        ...
        <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden opacity-70">
          <div className="p-4 md:px-6 md:py-4 border-b border-slate-100">
            <div className="flex items-center gap-2">
              ...
              <h3 className="text-sm font-medium text-slate-600">Sem gestor vinculado</h3>
              <span className="text-xs bg-slate-100 text-slate-500 px-2 py-0.5 rounded-full">
                {data.semGestor.length}
              </span>
            </div>
          </div>
          <div className="divide-y divide-slate-50">
            {data.semGestor.map((nome: string) => (
              <div key={nome} className="flex items-center gap-3 px-6 md:px-10 py-2.5">
                <div className="w-6 h-6 rounded-full bg-slate-200 flex items-center justify-center text-slate-500 font-bold text-[9px]">
