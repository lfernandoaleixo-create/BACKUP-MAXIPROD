...
function getCobrancaSteps(): GuideStep[] {
  return [
    ...
    },
    {
      ...
      description: "Ao clicar no telefone, registre a ação realizada (WhatsApp ou E-mail). Isso fica salvo no histórico do título como prova formal.",
      icon: CheckCircle2,
      ...
      details: [
        ...
        "O telefone para de vibrar quando a ação do dia for registrada",
    ...
    },
    {
      ...
      description: "No dia 2 o telefone não vibra. É um dia de espera. Mas se a ação do dia 1 não foi registrada, o telefone continua vibrando!",
      icon: Clock,
    ...
    },
    {
      ...
      details: [
        ...
        "Registre a ação realizada: tipo 'Ligação' ou tipo 'E-mail'",
      ],
    },
    {
      itemNumber: "3.1",
    ...
    },
    {
      ...
      dayLabel: "DIA 4",
      details: [
        "Mesma regra do dia 2: se a ação anterior está pendente, telefone vibra",
    ...
    },
    {
      ...
      details: [
        ...
        "⏸️ Dia 2 → Intervalo (pendência anterior continua vibrando)",
        "📞📧 Dia 3 → Ligação + E-mail (2º contato, mais incisivo)",
        "⏸️ Dia 4 → Intervalo",
        "📞📧 Dia 5 → Ligação + E-mail (último contato, aviso de protesto)",
        "📋 Dia 6 → Preparação para decisão (revisão dos registros formais)",
